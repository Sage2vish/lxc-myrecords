...
const styles = StyleSheet.create({
  ...
  glassHeader: {
    ...
    paddingVertical: 10,
    borderRadius: 22,
    backgroundColor: Platform.OS === 'android' ? 'rgba(255,255,255,0.24)' : 'rgba(255,255,255,0.54)',
    borderWidth: 1,
    borderColor: Platform.OS === 'android' ? 'rgba(255,255,255,0.34)' : 'rgba(255,255,255,0.2)',
    overflow: 'hidden',
    shadowColor: Platform.OS === 'android' ? '#FFFFFF' : '#000',
    shadowOpacity: Platform.OS === 'android' ? 0.10 : 0.12,

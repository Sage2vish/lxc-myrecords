...
const styles = StyleSheet.create({
  ...
  glassHeader: {
    ...
    paddingVertical: 10,
    borderRadius: 22,
    backgroundColor: Platform.OS === 'android' ? 'rgba(18,117,214,0.30)' : 'rgba(255,255,255,0.54)',
    borderWidth: 1,
    borderColor: Platform.OS === 'android' ? 'rgba(172,228,255,0.22)' : 'rgba(255,255,255,0.2)',
    overflow: 'hidden',
    shadowColor: Platform.OS === 'android' ? '#49A7FF' : '#000',
